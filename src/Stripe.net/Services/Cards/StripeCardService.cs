namespace Stripe
{
    ...
    public class StripeCardService : StripeService
    {
        ...
        public virtual async Task<StripeCard> GetAsync(string customerId, string cardId, bool isRecipient = false, StripeRequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            var url = this.SetupUrl(customerId, cardId);
